...
const Section4 = () => {
  ...
  return (
    <motion.div initial="" animate=""  ref={scene} className="relative h-screen ">
      ...
      <div className="text-white overflow-hidden">
        <div className=" flex  flex-col sm:flex sm:flex-row gap-10 items-center justify-evenly py-5 ">
          <Rounded>
            <h2 className="sm:w-32 md:w-40 flex justify-center items-center text-sm rounded-sm">
              gouravsingh4495@gamil.com
            </h2>
          </Rounded>
          <Rounded>
            <h2 className="w-15 sm:w-32 md:w-40  text-sm rounded-sm">
              +91 954 1560 130
            </h2>
          </Rounded>
        </div>
